...
export class API_CODE {
  ...
  @ApiCodeDescription('登录到自动化预约服务失败')
  static LOGIN_FAILED = 3000

  @ApiCodeDescription('用户名或密码错误')
  static USERNAME_OR_PASSWORD_ERROR = 3001

  @ApiCodeDescription('邀请码无效')
  static INVITE_CODE_INVALID = 3002

  @ApiCodeDescription('两次输入的密码不一致')
  static PASSWORD_MISMATCH_ERROR = 3003
}
